...
public class WheelTime {
    ...
    public void setPicker(int year, int month, int day) {
        this.setPicker(year, month, day, 0, 0, 0, Calendar.getInstance());
    }

    public void setPicker(int year, final int month, int day, int h, int m, int s, Calendar calendar) {
        /** 保存传入的时间 */
        ...
        if (currentYear == startYear) {
           /* int i = wv_month.getCurrentItem() + startMonth;
            ...
            if ((wv_month.getCurrentItem() + startMonth) == startMonth) {
                sb.append(type[0] ? (wv_year.getCurrentItem() + startYear) : currentCalendar.get(Calendar.YEAR)).append("-")
                        .append(type[1] ? (wv_month.getCurrentItem() + startMonth) : (currentCalendar.get(Calendar.MONTH) + 1)).append("-")
                        .append(type[2] ? (wv_day.getCurrentItem() + startDay) : currentCalendar.get(Calendar.DAY_OF_MONTH)).append(" ")
                        .append(type[3] ? wv_hours.getCurrentItem() : currentCalendar.get(Calendar.HOUR_OF_DAY)).append(":")
                        .append(type[4] ? wv_mins.getCurrentItem() : currentCalendar.get(Calendar.MINUTE)).append(":")
                        .append(type[5] ? wv_seconds.getCurrentItem() : currentCalendar.get(Calendar.SECOND));
            } else {
                sb.append(type[0] ? (wv_year.getCurrentItem() + startYear) : currentCalendar.get(Calendar.YEAR)).append("-")
                        .append(type[1] ? (wv_month.getCurrentItem() + 1) : (currentCalendar.get(Calendar.MONTH) + 1)).append("-")
                        .append(type[2] ? (wv_day.getCurrentItem() + startDay) : currentCalendar.get(Calendar.DAY_OF_MONTH)).append(" ")
                        .append(type[3] ? wv_hours.getCurrentItem() : currentCalendar.get(Calendar.HOUR_OF_DAY)).append(":")
                        .append(type[4] ? wv_mins.getCurrentItem() : currentCalendar.get(Calendar.MINUTE)).append(":")
                        .append(type[5] ? wv_seconds.getCurrentItem() : currentCalendar.get(Calendar.SECOND));
            ...
            sb.append(type[0] ? (wv_year.getCurrentItem() + startYear) : currentCalendar.get(Calendar.YEAR)).append("-")
                    .append(type[1] ? (wv_month.getCurrentItem() + 1) : (currentCalendar.get(Calendar.MONTH) + 1)).append("-")
                    .append(type[2] ? (wv_day.getCurrentItem() + 1) : currentCalendar.get(Calendar.DAY_OF_MONTH)).append(" ")
                    .append(type[3] ? wv_hours.getCurrentItem() : currentCalendar.get(Calendar.HOUR_OF_DAY)).append(":")
                    .append(type[4] ? wv_mins.getCurrentItem() : currentCalendar.get(Calendar.MINUTE)).append(":")
                    .append(type[5] ? wv_seconds.getCurrentItem() : currentCalendar.get(Calendar.SECOND));
        }
