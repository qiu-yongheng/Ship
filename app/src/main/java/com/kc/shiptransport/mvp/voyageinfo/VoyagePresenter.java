...
public class VoyagePresenter implements VoyageContract.Presenter{
    private final Context context;
    private final VoyageContract.View view;
    private final DataRepository dataRepository;
    private final CompositeDisposable compositeDisposable;

    public VoyagePresenter(Context context, VoyageContract.View view, DataRepository dataRepository) {
